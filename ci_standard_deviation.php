...
Version: 1.0.0
Author: Standard Deviation / www.calculator.io
...
function display_calcio_ci_standard_deviation(){
    $page = 'index.html';
...
add_shortcode( 'ci_standard_deviation', 'display_calcio_ci_standard_deviation' );